...
public class SensorTestActivity extends AppCompatActivity {
    ...
    private TextView gyrView;
    private TextView preView;
    private TextView graView;
    private TextView l_accView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accView = findViewById(R.id.textView1);
        magView = findViewById(R.id.textView2);
        gyrView = findViewById(R.id.textView3);
        preView = findViewById(R.id.textView4);
        graView = findViewById(R.id.textView5);
        l_accView = findViewById(R.id.textView6);
        oriView = findViewById(R.id.textView7);
            ...
            switch (event.sensor.getType()) {
                ...
                case Sensor.TYPE_GYROSCOPE:
                    ...
                    String gyroscope = "陀螺仪传感器(度)\n" + "x:"
                            ...
                            + (gyr[1]) + "\n" + "z:"
                            + (gyr[2]);
                    gyrView.setText(gyroscope);
                    timestamp = event.timestamp;
                    break;
                case Sensor.TYPE_PRESSURE:
                    pre = event.values[0];
                    String pressure = "压力传感器（hPa）\n" + pre;
                    preView.setText(pressure);
                    break;
                ...
                case Sensor.TYPE_LINEAR_ACCELERATION:
                    ...
                    String linear_acceleration = "线性加速度传感器(m/s^2)\n" + "x:"
                            ...
                            + ((int) l_acc[1]) + "\n" + "z:"
                            + ((int) l_acc[2]);
                    l_accView.setText(linear_acceleration);
                    break;
